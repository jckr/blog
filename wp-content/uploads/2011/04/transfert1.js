...
vis2.add(pv.Panel).left(20).top(-300*toursDifD[1].diff/totD).width(80).height(-300*toursDifD[5].diff/totD).fillStyle(partisDetails.ABS.color).title("Absentions - "+toursDifD[4].diff+" voix").anchor("center").add(pv.Label).text("Abstentionnistes");
...
vis3.add(pv.Panel).left(20).top(-300*toursDifG[2].diff/totG).width(80).height(-300*toursDifG[5].diff/totG).fillStyle(partisDetails.ABS.color).title("Absentions - "+toursDifG[4].diff+" voix").anchor("center").add(pv.Label).text("Abstentionnistes");
